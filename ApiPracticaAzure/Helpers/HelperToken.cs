...
namespace ApiPracticaAzure.Helpers {
    public class HelperToken {
        ...
        //MÉTODO PARA LA CONFIGURACION DEL TOKEN DE SEGURIDAD QUE SE GENERARÁ
        //Al ser un método de configuracion, devuelven un Action.
